  ...
  steps: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'court', label: 'Визначить суд' },
      ],
      show_if: { field: 'has_children', operator: '==', value: true },
      animation: 'slide-down',
    },
    {
      ...
      tab: 'marriage',
      type: 'choice',
      label: 'Графік участі у вихованні / побачень з дитиною',
      options: [
        { value: 'none', label: 'Домовились' },
        { value: 'separate', label: 'Є спір, вирішуватиметься окремо' },
      ],
      hint: 'Йдеться про того з батьків, хто проживатиме окремо від дитини (ст. 157 СК).',
      show_if: { any: [
        { field: 'children_live_with', operator: '==', value: 'plaintiff' },
        { field: 'children_live_with', operator: '==', value: 'defendant' },
      ] },
      animation: 'slide-down',
    },
    {
      id: 'visitation_schedule_text',
      tab: 'marriage',
      type: 'textarea',
      label: 'Узгоджений графік побачень',
      placeholder: 'Кожні вихідні з п\'ятниці по неділю; половина літніх канікул',
      show_if: { field: 'visitation_dispute', operator: '==', value: 'none' },
      animation: 'slide-down',
    },
    {
      id: 'children_dispute',
