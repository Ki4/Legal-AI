// Copied VERBATIM from apps/client/src/lib/conditions.ts (only the type import
// path is adapted for NodeNext). Do not edit here — fix the client original and
// re-copy. Drift is guarded by src/__tests__/parity.test.ts.

import type { Answers, SingleCondition, ShowIfCondition } from './types.js'
