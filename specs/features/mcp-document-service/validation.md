...
- [x] Живое демо у Сергея пройдено (2026-07-11, новая сессия с .mcp.json): полный интейк alimony через legal-intake→alimony-claim, перепрос битого IBAN, генерация OK, отказ divorce. Вердикт Сергея: логика MCP+skills работает → merge. Находки уровня услуги (не каркаса): [DEMO-FINDINGS-2026-07-11.md](DEMO-FINDINGS-2026-07-11.md) — A (шаблон: прочерк defendant_birth_date, средний) и B (недетерминированное AI-склонение без маркера в файле, ВЫСОКИЙ) — follow-up после merge.
