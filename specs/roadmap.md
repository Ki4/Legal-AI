...
### 2.3 Складні послуги (T2 — гібридний документ)

> Таксономія рівнів послуг T1/T2/T3 + переиспользуемый AI-харнесс: `docs/research/service-tiers-and-ai-harness.md`.
...
- [ ] Поділ майна 🔵 (друга T2-ітерація — «вибухова комбінаторика», після обкатки харнесса)
